...
class CartModelRepository implements CartRepository
{
    ...
    //       ItemsOrder::where('order_id',$order->id)->where('product_id',$cart->product_id)->update([
    //         'quantity' => $quantity,
    //         'total' => $cart->total
    //       ]);
    ...
    public function update($id, $quantity)
{
    ...
    if ($order) {
        $itemOrder = ItemsOrder::where('order_id', $order->id)
    ...
    //         ->delete();
    //      $order =    Order::where('user_id',$cart->user_id)->first();
    //         ItemsOrder::where('order_id', $order->id)->where('product_id',$cart->product_id)->delete();
