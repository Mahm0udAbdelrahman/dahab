            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Add Category') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('Admin.home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('Admin.categories.index') }}">{{ __('Category') }}</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Add Category') }}</li>
                    </ul>
                </div>
            </div>
