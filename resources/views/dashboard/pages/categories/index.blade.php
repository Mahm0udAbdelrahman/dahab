            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Category') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-center">
                                <table id="example2" class="table table-striped table-bordered">
                                    ...
                                    <form action="{{ route('Admin.categories.bulkDelete') }}" method="post" id="bulkDeleteForm">
                                        @csrf
                                        ...
                                        <tbody>
                                            @forelse($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>{{ $category->is_active == 1 ? 'Active' : 'Unactive' }}</td>
                                                    <td>
