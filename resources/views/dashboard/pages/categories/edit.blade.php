            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Edit Category') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[ar]" id="name_ar"
                                            value="{{ old('name.ar', data_get($category->name, 'ar', '')) }}"
                                            class="form-control" placeholder="{{ __('Enter the category name') }}">
                                        @error('name.ar')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[en]" id="name_en"
                                            value="{{ old('name.en', data_get($category->name, 'en', '')) }}"
                                            class="form-control" placeholder="{{ __('Enter the category name') }}">
                                        @error('name.en')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
